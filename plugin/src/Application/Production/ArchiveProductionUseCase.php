...
/**
 * COMPLETED -> ARCHIVED ("決算完了" -> "Archive"). PrimaryManager-
 * exclusive per ProductionDelegatePolicy.md's Lifecycle Relationship
 * table. See Production::archive()'s docblock for this Phase's
 * discovered mismatch with the pre-existing COMPLETED->ARCHIVED guard.
 */
final class ArchiveProductionUseCase
{
    ...
    public function execute(ArchiveProductionCommand $command): ProductionResult
    {
