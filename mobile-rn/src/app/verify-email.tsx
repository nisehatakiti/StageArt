...
export default function VerifyEmailScreen() {
  ...
  return (
    <AuthLayout>
      ...
      {state === 'success' && (
        <>
          <ThemedText testID="verify-email-success" style={authStyles.description}>
            メールアドレスの確認が完了しました。
          </ThemedText>
          {Platform.OS === 'web' ? (
            <>
              ...
              <TouchableOpacity testID="verify-email-continue" onPress={() => router.replace('/login')} style={authStyles.button}>
                <ThemedText style={authStyles.buttonText}>ログイン画面へ</ThemedText>
              </TouchableOpacity>
              <TouchableOpacity
              ...
              >
                <ThemedText style={authStyles.buttonSecondaryText}>StageArtアプリを開く</ThemedText>
              </TouchableOpacity>
            </>
          ) : (
            <>
      ...
      {state === 'error' && (
        <>
          <ThemedText testID="verify-email-error" style={authStyles.description}>
